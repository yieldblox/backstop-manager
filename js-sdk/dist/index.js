...
export class BlendLockupContract extends Contract {
     ...
     */
    claim(assets) {
        return this.call("claim", ...BLEND_LOCKUP_SPEC.funcArgsToScVals("claim", { assets })).toXDR("base64");
    }
    /**
     ...
     */
    b_deposit(backstop, backstop_token, pool_address, amount) {
        return this.call("b_deposit", ...BLEND_LOCKUP_SPEC.funcArgsToScVals("b_deposit", {
            backstop,
            backstop_token,
            pool_address,
            amount,
     ...
     */
    b_queue_withdrawal(backstop, pool_address, amount) {
        return this.call("b_queue_withdrawal", ...BLEND_LOCKUP_SPEC.funcArgsToScVals("b_queue_withdrawal", {
            backstop,
            pool_address,
            amount,
        })).toXDR("base64");
     ...
     */
    b_dequeue_withdrawal(backstop, pool_address, amount) {
        return this.call("b_dequeue_withdrawal", ...BLEND_LOCKUP_SPEC.funcArgsToScVals("b_dequeue_withdrawal", {
            backstop,
            pool_address,
            amount,
        })).toXDR("base64");
     ...
     */
    b_withdraw(from, pool_address, amount) {
        return this.call("b_withdraw", ...BLEND_LOCKUP_SPEC.funcArgsToScVals("b_withdraw", {
            from,
            pool_address,
            amount,
        })).toXDR("base64");
     ...
     */
    b_claim(backstop, pool_addresses) {
        return this.call("b_claim", ...BLEND_LOCKUP_SPEC.funcArgsToScVals("b_claim", {
            backstop,
            pool_addresses,
        })).toXDR("base64");
    }
     ...
     */
    c_join_pool(backstop_token, pool_amount_out, max_amounts_in) {
        return this.call("c_join_pool", ...BLEND_LOCKUP_SPEC.funcArgsToScVals("c_join_pool", {
            backstop_token,
            pool_amount_out,
            max_amounts_in,
        })).toXDR("base64");
     ...
     */
    c_exit_pool(backstop_token, burn_amount, min_amounts_out) {
        return this.call("c_exit_pool", ...BLEND_LOCKUP_SPEC.funcArgsToScVals("c_exit_pool", {
            backstop_token,
            burn_amount,
            min_amounts_out,
        })).toXDR("base64");
